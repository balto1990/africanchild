...
CREATE TABLE `users` (
  ...
  `fist_name` varchar(45) NOT NULL default '',
  `signin` varchar(12) NOT NULL default '',
...
INSERT INTO `users` (`id`,`last_name`,`fist_name`,`signin`,`password`) VALUES 
